export default function ResourcesPreview() {
  const resources = [
    {
      title: "Enterprise RAID Log Pack",
      category: "Project Management",
      description:
        "A professional RAID log template designed for project managers, Scrum Masters and PMOs managing enterprise delivery.",
    },
    {
    ...
    },
    {
      ...
      description:
        "A comprehensive project planning template covering scope, milestones, dependencies, governance and reporting.",
    },
    {
