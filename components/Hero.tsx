...
export default function Hero() {
  return (
    <>
      ...
      <section className="border-y border-white/10 bg-slate-950 py-6">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-8 px-6 text-sm font-medium text-slate-400">
          <span className="uppercase tracking-[0.3em] text-cyan-300">
