...
const experiences = [
...

  {
    ...
    outcome:
      "Increased delivery throughput by 25%.",
...

  {
    ...
    outcome:
      "Delivered on time and achieved 95% stakeholder satisfaction.",
...
export default function Experience() {
  return (
    <section
      id="experience"
      className="bg-[#0B0F1A] px-6 py-28 text-white"
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-400">
            Delivering Agile, cloud, DevOps and enterprise
            transformation initiatives across financial
            services, healthcare, retail and aviation.
          </p>
        </div>
